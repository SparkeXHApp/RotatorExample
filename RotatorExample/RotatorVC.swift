...
class RotatorVC: UIViewController {
    ...
    var videoW: CGFloat = UIScreen.main.bounds.width
    var videoH: CGFloat = UIScreen.main.bounds.height / 3
    var btnW: CGFloat = UIScreen.main.bounds.width / 3
    var btnH: CGFloat = 60
    var pptW: CGFloat = 180
    var pptH: CGFloat = 140
    var margin: CGFloat = 20
    var videoTopH: CGFloat = 60
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        SparkRotator.shared.isLockOrientation = false
        SparkRotator.shared.orientationMaskDidChange = { orientationMask in
    ...
    override func viewWillTransition(to size: CGSize, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        DispatchQueue.main.async {
            ...
            if SparkRotator.shared.isPortrait {
    ...
    func updatePortrait() {
        UIView.animate(withDuration: 0.25) {
            ...
            self.lockBtn.frame = CGRect(x: self.ScreenW - 60, y: (self.videoTopH - 40) / 2, width: 40, height: 40)
        }
    ...
    @objc func lock(_ sender: UIButton) {
        ...
        SparkRotator.shared.isLockOrientation = sender.isSelected
    }
    ...
    lazy var lockBtn: UIButton = {
        let lockImg = UIImage(systemName: "lock.slash", withConfiguration: UIImage.SymbolConfiguration(pointSize: 22.0, weight: .medium, scale: .large))?.withTintColor(#colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1), renderingMode: .alwaysOriginal)
        let unlockImg = UIImage(systemName: "lock.open", withConfiguration: UIImage.SymbolConfiguration(pointSize: 22.0, weight: .medium, scale: .large))?.withTintColor(#colorLiteral(red: 0.1764705926, green: 0.4980392158, blue: 0.7568627596, alpha: 1), renderingMode: .alwaysOriginal)
